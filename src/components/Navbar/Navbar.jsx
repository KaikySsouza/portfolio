...
function Navbar() {
  ...
  return (
    <div>
      ...
      <div>
      <nav className="flex justify-between items-center bg-[#011b4b4f]">
        <li className="m-5 text-[20px]">  &lt;/Kaiky&gt;</li>
        <ul className="inline-flex space-x-8 m-[10px] text-[15px] text-[#00000]">
